...
GLFWwindow* create_window_glfw(const char* window_name = "", bool resize = true) {
    ...
    return glfwCreateWindow(2560, 1440, window_name, NULL, NULL);
}
...
int device_initialization(Engine::Init& init) {
...
int create_swapchain(Engine::Init& init) {
...
int get_queues(Engine::Init& init, Engine::RenderData& data) {
...
int create_render_pass(Engine::Init& init, Engine::RenderData& data) {
...
VkShaderModule createShaderModule(Engine::Init& init, const std::vector<char>& code) {
...
int create_graphics_pipeline(Engine::Init& init, Engine::RenderData& data, std::string shader_path) {

    std::cout << "Dir-path: " << shader_path << "\n";

    auto vert_code = readFile(shader_path + "/vert.spv");
    auto frag_code = readFile(shader_path + "/frag.spv");
...
int create_framebuffers(Engine::Init& init, Engine::RenderData& data) {
...
int create_command_pool(Engine::Init& init, Engine::RenderData& data) {
...
int create_command_buffers(Engine::Init& init, Engine::RenderData& data) {
...
int create_sync_objects(Engine::Init& init, Engine::RenderData& data) {
...
int recreate_swapchain(Engine::Init& init, Engine::RenderData& data) {
...
int draw_frame(Engine::Init& init, Engine::RenderData& data) {
...
void cleanup(Engine::Init& init, Engine::RenderData& data) {
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
